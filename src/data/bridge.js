...
export const receiveMessage = msg => {
    // alert(msg.replace(/&quot;/g, '\"'))
    // alert(JSON.parse(msg.replace(/&quot;/g, '\"')))
    // const data = JSON.parse(msg.replace(/&quot;/g, '\"'));
    ...
    // }
    if (data.oper === 'handle') {
        store.commit(`${NameSpaces.AUTO}/getInitData`, { data });
        // store.commit(`${NameSpaces.SEMI_AUTO}/setInitData`, {
        //     customerId: data.openId,
        //     name: data.name,
        //     avatar: data.avatar || 'data:image/jpeg;base64,'
    ...
    if (data.operObject == 'switch') {
        store.commit(`${NameSpaces.AUTO}/switchBotC`, {data});
    }
}